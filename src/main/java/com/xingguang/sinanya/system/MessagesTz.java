...
public class MessagesTz {
    ...
    private static ArrayList<String> TZ1 = new ArrayList<String>() {{
    ...
    private static ArrayList<String> TZ2 = new ArrayList<String>() {{
        add("任意选择一个特性");
    ...
    private static ArrayList<String> TZ3 = new ArrayList<String>() {{
    ...
    private static ArrayList<String> TZ4 = new ArrayList<String>() {{
        add("任意选择一个特性");
    ...
    private static ArrayList<String> TZ5 = new ArrayList<String>() {{
    ...
    private static ArrayList<String> TZ6 = new ArrayList<String>() {{
        add("重新投掷一次，如果是（D）的特性就再任意选择一个不带（D）的特性获得，如果说是不带（D）的特性，那么就任意选择一个带（D）特性获得。");
    ...
    private static ArrayList<String> TZ7 = new ArrayList<String>() {{
