 ...
 */
public class CardTooMoreException extends Exception {
    public CardTooMoreException(EntityTypeMessages entityTypeMessages) {
        super("最高一次生成10张");
        sender(entityTypeMessages, "最高一次生成10张");
    }
}
