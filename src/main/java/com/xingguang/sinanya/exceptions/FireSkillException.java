 ...
 */
public class FireSkillException extends Exception {
    public FireSkillException(EntityTypeMessages entityTypeMessages) {
        super("您只能使用本页中规定的技能");
        sender(entityTypeMessages, "您只能使用本页中规定的技能");
    }
}
