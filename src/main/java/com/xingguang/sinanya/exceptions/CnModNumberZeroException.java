 ...
 */
public class CnModNumberZeroException extends Exception {
    public CnModNumberZeroException(EntityTypeMessages entityTypeMessages) {
        super("此关键字未找到任何模组");
        sender(entityTypeMessages, "此关键字未找到任何模组");
    }
}
