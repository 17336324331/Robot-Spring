 ...
 */
public class RollCantInZeroException extends Exception {
    public RollCantInZeroException(EntityTypeMessages entityTypeMessages) {
        super("骰点次数不可小于等于0");
        sender(entityTypeMessages, "骰点次数不可小于等于0");
    }
}
