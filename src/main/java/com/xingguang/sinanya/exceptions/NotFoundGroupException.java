 ...
 */
public class NotFoundGroupException extends Exception {
    public NotFoundGroupException(EntityTypeMessages entityTypeMessages) {
        super("未找到相关群");
        sender(entityTypeMessages, "未找到相关群");
    }
}
