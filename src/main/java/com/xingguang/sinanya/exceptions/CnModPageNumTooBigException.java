 ...
 */
public class CnModPageNumTooBigException extends Exception {
    public CnModPageNumTooBigException(EntityTypeMessages entityTypeMessages) {
        super("结果集没有这么多页");
        sender(entityTypeMessages, "结果集没有这么多页");
    }
}
