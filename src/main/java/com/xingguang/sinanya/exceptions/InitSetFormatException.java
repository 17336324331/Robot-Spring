 ...
 */
public class InitSetFormatException extends Exception {
    public InitSetFormatException(EntityTypeMessages entityTypeMessages) {
        super("请按照以下格式输入:\n.init set [角色] [点数]\n如.init set 老热望 1");
        sender(entityTypeMessages, "请按照以下格式输入:\n.init set [角色] [点数]\n如.init set 老热望 1");
    }
}
