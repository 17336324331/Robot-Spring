 ...
 */
public class WhiteListInputNotIdException extends Exception {
    public WhiteListInputNotIdException(EntityTypeMessages entityTypeMessages) {
        super("输入的不是群号或QQ号");
        sender(entityTypeMessages, "输入的不是群号或QQ号");
    }
}
