...
import static com.xingguang.sinanya.tools.getinfo.GetMessagesToValue.getMessagesToValue;
import static com.xingguang.sinanya.tools.getinfo.RoleInfo.getRoleInfoFromChooseByFromQQ;
...
public class MakeRolesInfo {
    ...
    private HashMap<String, Integer> makeProperties() {
        ...
        if (properties != null && !properties.equals(MessagesSystem.NONE)) {
