...
import com.xingguang.sinanya.entity.MailBean;
...
//        这里取相对路径"bin/../saveLogs/${groupId}/${logName}"
        mb.attachFile(GetMessagesProperties.entitySystemProperties.getSystemDir() + "/saveLogs/" + groupId + "/" + logName + "-NotHide.txt");
        mb.attachFile(GetMessagesProperties.entitySystemProperties.getSystemDir() + "/saveLogs/" + groupId + "/" + logName + ".txt");
        if (new File(GetMessagesProperties.entitySystemProperties.getSystemDir() + "/saveLogs/" + groupId + "/" + logName + ".docx").exists()) {
            mb.attachFile(GetMessagesProperties.entitySystemProperties.getSystemDir() + "/saveLogs/" + groupId + "/" + logName + ".docx");
        }
