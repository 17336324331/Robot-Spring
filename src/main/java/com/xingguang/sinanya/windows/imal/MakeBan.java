...
import com.xingguang.sinanya.tools.windows.Lable;
import com.xingguang.sinanya.tools.windows.RadioButton;
import com.xingguang.sinanya.tools.windows.Text;
...
public class MakeBan extends MessagesWindows {
    ...
    public void info(JPanel jPanel) {
        ...
        lable.createLable(jPanel, String.valueOf(loginInfo.getLoginId()));

        lable.createLable(jPanel, "你当前登录的骰娘昵称为:\t");
        lable.createLable(jPanel, loginInfo.getLoginName());
    }
    ...
    public void master(JPanel jPanel) {
        ...
        master.setText(StringUtil.joiner(entityBanProperties.getMaster(), ","));
