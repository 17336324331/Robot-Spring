...
public class EntitySystemProperties {
    ...
    public void setSymptom(String symptom) {
        if (symptom.equals(NONE) || symptom.contains("\n")) {
    ...
    public String getEnSuccess() {
        return enSuccess.replaceAll(" +", "");
    }

    public void setEnSuccess(String enSuccess) {
        if (enSuccess.equals(NONE) || enSuccess.contains("\n")) {
    ...
    public String getEnFailed() {
        return enFailed.replaceAll(" +", "");
    }

    public void setEnFailed(String enFailed) {
        if (enFailed.equals(NONE) || enFailed.contains("\n")) {
