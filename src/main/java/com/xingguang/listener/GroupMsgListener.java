...
public class GroupMsgListener {
     ...
     * @param sender
     */
    @Filter(value = "refesh",keywordMatchType = KeywordMatchType.TRIM_EQUALS)
    @Listen(MsgGetTypes.groupMsg)
    public void listen0(GroupMsg msg,  MsgSender sender){
        //启动成功之后，初始化一些基础参数
        // 1.master初始化
    ...
    @Listen(MsgGetTypes.groupMsg)
    public void listen1(GroupMsg msg,  MsgSender sender){
